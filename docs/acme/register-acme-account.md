...
In order to use the ACME protocol to request a certificate from PKIaaS.io, an ACME account must first be registered using an EAB. See the links below for more information about getting started with various ACME clients.
