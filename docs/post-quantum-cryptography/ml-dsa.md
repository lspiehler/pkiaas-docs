...
In order to issue an ML-DSA certificate, a CSR must be generated with a ML-DSA private key. This can be done using tools like OpenSSL OpenSSL (version 3.5 or higher) or online at [https://certificatetools.com/](https://certificatetools.com/) by selecting one of the ML-DSA private key options from the **Private Key** dropdown.
