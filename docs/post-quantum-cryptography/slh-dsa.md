...
---
## Create an SLH-DSA Certificate Authority
...
In order to issue an SLH-DSA certificate, a CSR must be generated with an SLH-DSA private key. This can be done using tools like OpenSSL (version 3.5 or higher) or online at [https://certificatetools.com/](https://certificatetools.com/) by selecting one of the SLH-DSA private key options from the **Private Key** dropdown.
